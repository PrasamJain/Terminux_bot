...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //on below line we are initializing our adapter class and passing our array lit to it.
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=166782&key=bL9YDyiipDtx8bKL&uid=[uid]&msg=" + userMsg;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                //error handling.
                messageModalArrayList.add(new MessageModal("Sorry, Unable to connect from API", BOT_KEY));
